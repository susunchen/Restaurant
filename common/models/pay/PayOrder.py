...
class PayOrder(db.Model):
    ...
    qrcode_id = db.Column(db.String(128), nullable=True, server_default=db.FetchedValue())
    sent_member_id = db.Column(db.BigInteger, nullable=True, server_default=db.FetchedValue())
    hall_id = db.Column(db.BigInteger, nullable=True, server_default=db.FetchedValue())
    cabint_id = db.Column(db.BigInteger, nullable=True, server_default=db.FetchedValue())
