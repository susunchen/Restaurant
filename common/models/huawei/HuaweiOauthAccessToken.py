...
class HuaweiOauthAccessToken(db.Model):
    __tablename__ = 'huawei_iot_access_token'

    id = db.Column(db.Integer, primary_key=True)
    access_token = db.Column(db.String(600), nullable=False, server_default=db.FetchedValue())
    refresh_token = db.Column(db.String(600), nullable=False, server_default=db.FetchedValue())
